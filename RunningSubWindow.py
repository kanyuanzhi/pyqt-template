...
class Ui_RunningSubWindow(object):
    ...
    def retranslateUi(self, RunningSubWindow):
        ...
        self.pushButtonLoadSetting.setText(_translate("RunningSubWindow", "加载参数"))
        self.labelLoadedSetting.setText(_translate("RunningSubWindow", "已加载："))
        self.pushButtonStart.setText(_translate("RunningSubWindow", "开始运行"))
        self.pushButtonStart_2.setText(_translate("RunningSubWindow", "选择目录"))
